...
/**
 * Large editorial trust section on paper — no icon cards, no numbering. Each
 * point is a Fraunces line and a short, plain-spoken paragraph. Renders nothing
        ...
        <div className="mt-12 md:mt-16">
          {items.map((item, i) => (
            <Reveal key={item.title} delay={Math.min(i * 0.04, 0.12)}>
              <div className="grid gap-3 border-t border-gray-200 py-8 first:border-t-0 md:py-10 lg:grid-cols-[1fr_1.55fr] lg:gap-12">
